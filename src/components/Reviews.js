...
const Reviews = ({ id, prevRating, userRated }) => {
  ...
  const sendReview = async () => {
    ...
    return (
      <div className='mt-2 border-t-2 border-gray-500w-full'>
        <ReactStars
          size={30}
          half={true}
          value={rating}
        ...
        {
          reviewsLoading ?
            <div className='mt-8 flex justify-center'><ThreeDots height={10} color='white' /></div>
            :
            <div className='mt-4'>
              {data.map((e, i) => {
                return (
                  <div className=' p-2 header w-full border-b border-gray-600 mt-2' key={i}>
